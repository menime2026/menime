...
export type { CollectionResponse, ProductResponse };
    ...
    <div className="grid gap-8 xl:grid-cols-[1.4fr_1fr]">
      <div className="flex flex-col gap-8 rounded-[2.5rem] bg-white p-8">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-light text-slate-900">Product catalog</h2>
            <p className="text-xs font-bold uppercase tracking-widest text-slate-500">{productRows.length} items</p>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" size="sm" className="rounded-full px-4 text-xs font-bold uppercase tracking-widest" onClick={() => queryClient.invalidateQueries({ queryKey: ["admin", "products"] })}>
              <RefreshCcw className="mr-2 h-3 w-3" /> Refresh
            </Button>
            <Button size="sm" className="rounded-full px-4 text-xs font-bold uppercase tracking-widest" onClick={resetForm}>
              <Plus className="mr-2 h-3 w-3" /> New product
            </Button>
          </div>
        </div>
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-8 rounded-[2.5rem] bg-white p-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs font-bold uppercase tracking-widest text-slate-500">Product Details</p>
            </div>
            {selectedProduct ? (
              <Button
                variant="destructive"
          ...
          <Form {...form}>
            <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Name</FormLabel>
                    <FormControl>
                      <Input className="rounded-xl border-slate-200 bg-slate-50 focus:bg-white" placeholder="Essential denim jacket" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Slug</FormLabel>
                      <FormControl>
                        <Input className="rounded-xl border-slate-200 bg-slate-50 focus:bg-white" placeholder="essential-denim-jacket" {...field} />
                      </FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">SKU</FormLabel>
                      <FormControl>
                        <Input className="rounded-xl border-slate-200 bg-slate-50 focus:bg-white" placeholder="SKU-01" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input className="rounded-xl border-slate-200 bg-slate-50 focus:bg-white" type="number" step="0.01" min="0" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Compare at price</FormLabel>
                      <FormControl>
                        <Input className="rounded-xl border-slate-200 bg-slate-50 focus:bg-white" type="number" step="0.01" min="0" {...field} value={field.value ?? ""} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Available units</FormLabel>
                    <FormControl>
                      <Input className="rounded-xl border-slate-200 bg-slate-50 focus:bg-white" type="number" min="0" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea className="rounded-xl border-slate-200 bg-slate-50 focus:bg-white" rows={4} placeholder="Fabric, fit, and styling details" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Available sizes</FormLabel>
                      ...
                      <div className="flex gap-2">
                        ...
                        />
                        <Button type="button" variant="outline" className="rounded-full px-4 text-xs font-bold uppercase tracking-widest" onClick={addSize}>
                          Add
                        </Button>
                      </div>
                      {values.length > 0 ? (
              ...
              <FormField
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Available colors</FormLabel>
                      ...
                      <div className="flex gap-2">
                        ...
                        />
                        <Button type="button" variant="outline" className="rounded-full px-4 text-xs font-bold uppercase tracking-widest" onClick={addColor}>
                          Add
                        </Button>
                      </div>
                      {values.length > 0 ? (
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Collections</FormLabel>
                      ...
                      {collections.map((collection) => {
                        ...
                        return (
                          <label
                            key={collection.id}
                            className={cn(
                              "flex cursor-pointer items-center justify-between rounded-xl border border-slate-200 px-3 py-2 text-sm transition",
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex items-center justify-between rounded-xl border border-slate-200 px-4 py-3">
                    <div>
                      <FormLabel className="text-xs font-bold uppercase tracking-widest text-slate-500">Publish on storefront</FormLabel>
              ...
              <div className="flex justify-end gap-2">
                <Button type="button" variant="outline" className="rounded-full px-6 text-xs font-bold uppercase tracking-widest" onClick={resetForm} disabled={isSubmitting}>
                  Cancel
                </Button>
                <Button type="submit" className="rounded-full px-6 text-xs font-bold uppercase tracking-widest" disabled={isSubmitting}>
        ...
        {selectedProduct ? (
          <div className="rounded-[2.5rem] bg-white p-8">
            <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500">Snapshots</h3>
