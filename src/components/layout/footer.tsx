  ...
  const sections = [
    {
      ...
      content: 'Discover the world of Meni\'s, a brand synonymous with quality denim and timeless style since 1873. From iconic jeans to comfortable casual wear, Meni\'s India offers premium products for every lifestyle.'
    },
    {
      id: 'quick',
      title: 'QUICK LINKS',
      links: [
        { label: "Women's Jeans", href: "#" },
        { label: "Dresses", href: "#" },
        ...
        { label: "Red Tab Member Program", href: "#" },
    ...
    <footer className="bg-gray-100">
      ...
      <div className="hidden md:block max-w-7xl mx-auto md:py-2 md:px-4">
        <details className="group border-b border-gray-200 pb-1">
          <summary className="flex items-center justify-between cursor-pointer py-4 select-none">
            <h3 className="text-sm font-bold uppercase tracking-[0.3em] text-gray-900">More About Meni Me&rsquo;s India Store</h3>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div>
                ...
                <a href="mailto:customercare@menime.in" className="text-sm text-gray-600 hover:text-black transition-colors">
                  customercare@menime.in
                </a>
              </div>
              <div>
                <p className="text-xs font-semibold text-black -mb-1">For Order Escalation</p>
                <a href="mailto:feedbackmenime@menime.in" className="text-sm text-gray-600 hover:text-black transition-colors">
                  feedbackmenime@menime.in
                </a>
              </div>
              <div>
